...
function parseHop(data: ReturnType<typeof schema.parse>) {
  ...
  return {
    ...rest,
    alphaLow: alphaRange?.[0]?.[0],
    alphaHigh: alphaRange?.[1]?.[0],
    betaLow: betaRange?.[0]?.[0],
    betaHigh: betaRange?.[1]?.[0],
    caryophylleneLow: caryophylleneRange?.[0]?.[0],
    caryophylleneHigh: caryophylleneRange?.[1]?.[0],
    farneseneLow: farneseneRange?.[0]?.[0],
    farneseneHigh: farneseneRange?.[1]?.[0],
    humuleneLow: humuleneRange?.[0]?.[0],
    humuleneHigh: humuleneRange?.[1]?.[0],
    cohumuloneLow: cohumuloneRange?.[0]?.[0],
    cohumuloneHigh: cohumuloneRange?.[1]?.[0],
    totalOilLow: totalOilRange?.[0]?.[0],
    totalOilHigh: totalOilRange?.[1]?.[0],
    myrceneLow: myrceneRange?.[0]?.[0],
    myrceneHigh: myrceneRange?.[1]?.[0],
